...
class Feladat:
    ...
    def thirdLap(self):
        ...
        self.robot.aheadCm(3, 800, True)
        self.robot.rightOneWheel(Side.right, 800, 125)
        self.robot.aheadCm(-30, 800, True)
        self.robot.leftOneWheel(Side.left, 800, 33)
        self.robot.aheadCm(-40, 800, True)
        
        # self.robot.goUntilBlack(800, self.robot.rightSensor, True)
        # self.robot.aheadCm(-3, 200, True)
        # self.robot.moveLifter(200, Lift.carLift + 33, True)
        # self.robot.aheadCm(4, 200, True)
        # self.robot.moveLifter(200, Lift.maximum, False)
        # self.robot.aheadCm(6, 100, True)
