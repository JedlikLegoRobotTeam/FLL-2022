...
class Feladat:
    ...
    def firstTask(self):
        ...
        self.robot.aheadCm(distance=70, speed=700, stop=False)
        ...
        self.robot.aheadCm(speed=500, distance=29, stop=True)
    ...
    def thirdTask(self):
        ...
        self.robot.moveLifter(speed=200, measure=2, wait=True)
        self.robot.moveGrab(speed=300, measure=35, wait=True)
        self.robot.leftOneWheel(wheel=Side.right, speed=400, angle=-15)
        self.robot.aheadCm(distance=14, speed=600, stop=True)
        self.robot.moveGrab(speed=200, measure=Open.closing, wait=True)
        self.robot.aheadCm(distance=-5, speed=400, stop=True) #hatrebb jonni megfogas utan
        self.robot.moveLifter(speed=200, measure=100, wait=True)
        self.robot.leftOneWheel(wheel=Side.right, speed=400, angle=5)
        self.robot.aheadCm(distance=14, speed=400, stop=True)
        self.robot.moveGrab(speed=300, measure=Open.maximumOpen, wait=True)
        ...
        self.robot.moveGrab(speed=300, measure=Open.closing, wait=True)
        self.robot.aheadCm(distance=-11, speed=300, stop=True)
        self.robot.moveLifter(speed=200, measure=100, wait=True)
        self.robot.aheadCm(distance=15, speed=600, stop=True)
        self.robot.moveGrab(speed=300, measure=Open.maximumOpen, wait=True)
        self.robot.aheadCm(distance=-5, speed=200, stop=True)
    ...
    def fourthTask(self):
        ...
        self.robot.rightTwoWheel(speed=300, angle=91)
        self.robot.moveLifter(speed=300, measure=83, wait=True)
