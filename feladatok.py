...
class Feladat:
    ...
    def FourthLap(self):
        # First Task
        self.robot.moveGrab(400, Open.maximumOpen, False)
        # # self.robot.moveLifter(speed=400, measure=5, wait=True)
        self.robot.aheadCm(distance=70, speed=900, stop=False)
        self.robot.goUntilWhite(speed=900, szenzor=self.robot.leftSensor, stop=True)
        self.robot.aheadCm(-4.5, 800, True)
        self.robot.leftOneWheel(wheel=Side.right, speed=900, angle = 90)
        # self.robot.moveLifter(speed=400, measure=100, wait=False)
        # robot.aheadCm(distance=30, speed=500, stop=False)
        self.robot.alignOnWhite(-600)

        self.robot.aheadCm(speed=900, distance=46, stop=False)
        self.robot.ev3.speaker.beep()
        # self.robot.alignOnWhite(600)
        # self.robot.aheadCm(2, 800, True)
        self.robot.alignOnBlack(800)
        # self.robot.aheadForXSec(time_=0.5, speed=800)
        self.robot.grabMotor.run(-400)
        time.sleep(0.5)

        # SecondTask
        # self.robot.aheadCm(distance=-1, speed=400, stop=True)
        # self.robot.alignOnBlack(-800)
        self.robot.aheadCm(-6, 800, True)
        time.sleep(.4)
        self.robot.moveGrab(400, Open.maximumOpen, True)
        self.robot.moveLifter(200, Lift.maximum, True)
        self.robot.alignOnBlack(800)
        self.robot.aheadCm(2, 800, True)
        # self.robot.moveGrab(400, Open.maximumOpen, True)
        ...
        self.robot.leftOneWheel(wheel=Side.right, speed=900, angle=45)
        ...
        self.robot.aheadCm(distance=11, speed=900, stop=True)
        self.robot.grabMotor.run(-400)
        time.sleep(0.5)
        self.robot.aheadCm(distance=-6, speed=900, stop=True)
        self.robot.moveLifter(speed=900, measure=80, wait=True)
        self.robot.aheadCm(distance=10.5, speed=900, stop=True)
        # time.sleep(0.5)
        self.robot.ev3.speaker.beep()
        self.robot.moveGrab(speed=300, measure=Open.halfOpen, wait=True)
        ...
        # time.sleep(0.4)
        self.robot.rightTwoWheel(speed=900, angle=135)
        # self.robot.aheadCm()
        self.robot.aheadCm(-3, 800, True)
        self.robot.ev3.speaker.beep()
        self.robot.alignOnBlack(300)
        ...
        self.robot.aheadCm(distance=8, speed=900, stop=True)
        self.robot.grabMotor.run(-400)
        time.sleep(0.5)
        self.robot.aheadCm(-4, 800, True)
        ...
        self.robot.leftOneWheel(wheel=Side.left, speed=400, angle=17)  #TESZT
        self.robot.aheadCm(distance=15, speed=500, stop=True)
        self.robot.rightOneWheel(Side.left, 800, 10)
        self.robot.moveGrab(speed=500, measure=Open.maximumOpen, wait=True)
        self.robot.leftOneWheel(Side.right, 800, 10)
        ...
        self.robot.moveLifter(speed=300, measure=100, wait=True)
        self.robot.aheadCm(distance=15, speed=600, stop=True)
        self.robot.rightOneWheel(Side.left, 900, 10)
        self.robot.moveGrab(speed=500, measure=Open.maximumOpen, wait=True)
        self.robot.leftOneWheel(Side.left, 900, 10)
        self.robot.aheadCm(distance=-5, speed=600, stop=True)

        # Fourth Task
        self.robot.leftTwoWheel(speed=900, angle=95)
        # self.robot.moveGrab(speed=400, measure=Open.maximumOpen, wait=True)
        # self.robot.moveGrab(speed=300, measure=25, wait=False)
        ...
        self.robot.ev3.speaker.beep()
        self.robot.aheadCm(distance=10, speed=900, stop=False)
        self.robot.alignOnBlack(300)
        self.robot.aheadCm(distance=6, speed=900, stop=True)
        self.robot.rightTwoWheel(speed=900, angle=110)
        self.robot.moveLifter(200, 5, False)
        self.robot.aheadCm(distance=18, speed=900, stop=False)
        self.robot.alignOnBlack(300)
        self.robot.aheadCm(distance=-10, speed=400, stop=True)
        self.robot.grabMotor.run(-400)
        time.sleep(0.5)
        self.robot.moveGrab(400, 25, True)
        # self.robot.moveLifter(speed=200, measure=50, wait=True)
        self.robot.moveLifterForTime(200, 0.5)
        ...
        self.robot.leftOneWheel(wheel=Side.right, speed=900, angle=-50)
    ...
    def menu(self):
        ...
        while True:
            if Button.DOWN in self.robot.ev3.buttons.pressed():
                ...
                self.robot.liftingMotor.reset_angle(-19)
                self.robot.grabMotor.stop()
                self.robot.liftingMotor.stop()
                # self.robot.ev3.screen.clear()
